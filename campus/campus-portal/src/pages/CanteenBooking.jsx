...
function CanteenBooking() {
    ...
    return (
        <BookingLayout title="🍽 Canteen Slot Booking">
            ...
            <div className={styles.glassCard}>
                <p className={styles.sectionTitle}>Step 2 — Select Canteen Table / Area</p>
                {loading ? <p>Loading canteen slots…</p> : (
